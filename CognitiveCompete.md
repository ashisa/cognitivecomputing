| Service | Microsoft | Google | IBM | Amazon |
| --- | --- | --- | --- | --- |
| **Object detection in images** | **Computer Vision** | **Cloud Vision API** | **Visual Recognition** | **Rekognition Image** |
| Features | object detection, tags, automatic caption, adult content detection, racy content detection, categories, faces, age, gender, foreground color, background color, dominant color, OCR, celebrity recognition, handwritten OCR, generate thumbnails, label detection, scene detection, activity detection | object detection, tags, adult content detection, spoof content detection, violent content detection, medical content detection, logo detection, landmark detection, OCR, handwritten OCR, face detection, dominant color, related image search, web entity search, sentiment detection, label detection | object detection, tags, label detection, categories, faces, age, gender, celebrity recognition, custom classifier | object detection, scene detection, faces, facial attributes, adult content detection, racy content detection, similar face search, celebrity recognition, OCR, label detection |
| **Content moderation for images, video and text** | **Content Moderator API** |  |  |  |
| Features | classifiers, custom blacklist, OCR, custom text lists, personally identifiable information (pii) detection, adult content detection, human review workflow, machine-assisted text classification |  |  |  |
| **Video insights** | **Video Indexer** | **Cloud Video Intelligence API** |  | **Rekognition Video** |
| Features | audio transcription, face tracking, face detection, face recognition, face labeling, speaker indexing, celebrity recognition, visual text recognition, voice activity detection, scene dectection, keyframe detection, sentiment analysis, translation, content moderation, keywords extraction, annotation, video segmentation, brand detection | label detections, tags, shot detection, video segmentation, custom video classification with AutoML Video Intelligence (beta) |  | real-time analysis, face detection, face recognition, face tracking, face attributes, object detection, scene detection, activity detection, explicit content detection, celebrity recognition, obscured face tracking, similar face detection, emotion detection |
| **Face detection and verification in images** | **Face API** | **Cloud Vision API** |  | **Rekognition Image** |
| Features | face detection, face identification, face comparison, face recognition, similar face search, face grouping, face attributes, baldness detection, hair color detection, smile detection, gender, age, facial hair, glasses, makeup, sentiment/emotion detection, accessories, face landmarks, celebrity recognition, smile detection, sentiment/emotion detection | face detection, face attributes, smile detection, sentiment/emotion detection |  | object detection, scene detection, faces, sentiment/emotion detection, facial attributes, adult content detection, racy content detection, similar face search, celebrity recognition, OCR, label detection |
| **Custom computer vision models** | **Custom Vision Service** | **Cloud AutoML** | **Visual Recognition** |  |
| Features | custom classifier - vision, domains, coreml model export, tensorflow model export | custom classifier - vision/NL/translation, human labeling service  | tags, label detection, categories, faces, age, gender, celebrity recognition, custom classifier |  |
| **Layout aware OCR** | **Computer Vision** | **Cloud Vision API** |  | **Amazon Textract** |
| Features | OCR, bounding boxes | OCR, bounding boxes |  | OCR, key-value pair extraction, table extraction, bounding boxes, confidence score |
...
| **Speech to text** | **Speech-to-text, Text-to-speech** | **Cloud Speech API** | **Speech to Text/Text-to-Speech** | **Lex/Polly/Transcribe** |
| Features | speech-to-text, text-to-speech, custom speech model, custom vocabulary, custom language model, custom acoustic model, SSML | speech-to-text, text-to-speech, inappropriate content filtering | speech-to-text, speaker recognition, keyword extraction, acoustic alternatives, profanity filter, smart value formatting, expressiveness, voice transformations, custom voice model | speech-to-text, custom language models, multi-turn conversations, intent chaining, text-to-speech, custom acoustic model, custom vocabulary, SSML, text-to-speech |
...
| **Custom speech model** | **Speech-to-text, Text-to-speech** |  | **Speech to Text/Text-to-Speech** | **Lex/Polly/Transcribe** |
| Features | speech-to-text, text-to-speech, custom speech model, custom vocabulary, custom language model, custom acoustic model, SSML |  | speech-to-text, speaker recognition, keyword extraction, acoustic alternatives, profanity filter, smart value formatting, expressiveness, voice transformations, custom voice model | speech-to-text, custom language models, multi-turn conversations, intent chaining, text-to-speech, custom acoustic model, custom vocabulary, SSML, text-to-speech |
| **Natural language processing** | **Language Understanding Inteliigence Services (LUIS)** | **API.ai** | **Natural Language Classifier** | **Lex** |
